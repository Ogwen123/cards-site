...
const Register = () => {
    ...
    const submit = async (e: React.MouseEvent<HTMLButtonElement>) => {
        ...
        if (!res.ok) {
            ...
            setAlertData(["Email successfully sent.", true, "SUCCESS"])
            setLoading(false)
            setRegistered(true)
    ...
    if (!registered) {
        return (
            <div className="text-lg fc flex-col mt-[100px]">
                ...
                <div className='text-2xl my-5'>Register</div>
        ...
        return (
            <div className='flex items-center flex-col mh-body pt-[50px]'>
                <Alert message={alertData[0]} show={alertData[1]} severity={alertData[2]} />
                <div className="text-2xl text-white fc w-2/5 text-center pt-[20px]">An verification email has been sent to {email}.</div>
                <div>
                    Click on the verify link in the email to verify your email address and finish creating your account.
                </div>
            </div>
        )
    }
