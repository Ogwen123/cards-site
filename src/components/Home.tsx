        ...
        <div className="fc">
            <div className="flex items-center mh-body max-w-[50vw] flex-col pt-[30vh]">
                ...
                <div className="flex flex-row mt-[10px]">
                    <div className="max-w-sm p-6 border rounded-lg shadow-sm bg-bgdark border-gray-700 mr-[20px] w-[320px]">
                    ...
                    <div className="max-w-sm p-6 border rounded-lg shadow-sm bg-bgdark border-gray-700 ml-[20px] w-[320px]">
